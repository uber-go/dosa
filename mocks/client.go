...
func (_m *MockAdminClient) CanUpsertSchema(_param0 context.Context, _param1 string) (*dosa.SchemaStatus, error) {
	ret := _m.ctrl.Call(_m, "CanUpsertSchema", _param0, _param1)
	ret0, _ := ret[0].(*dosa.SchemaStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockAdminClientRecorder) CanUpsertSchema(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CanUpsertSchema", arg0, arg1)
}
